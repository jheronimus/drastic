...
typedef void (JNICALL *fn_onInit)(JNIEnv *env, jobject obj, jstring path, jstring savePath, jint apiLevel);
typedef jboolean (JNICALL *fn_startGame)(JNIEnv *env, jobject obj, jstring romPath, jint slot, jlong config, jint bootMode, jboolean customLayout, jlong ctx);
typedef void (JNICALL *fn_applyConfig)(JNIEnv *env, jobject obj, jlong config);
...
typedef jint (JNICALL *fn_getSnapshots16)(JNIEnv *env, jobject obj, jint format, jintArray top, jintArray bottom);
...
typedef void (JNICALL *fn_setAudioVolume)(JNIEnv *env, jobject obj, jint volume);
